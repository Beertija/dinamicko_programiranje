...
import 'package:dinamicko_programiranje/screens/postupak_screen.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => PostupakScreen(ispisProblemaPoRazdobljima: Provider.of<CalculateProvider>(context, listen: true).ispisProblemaPoRazdobljima[brRazdoblja]!)));
      },
      child: Card(
